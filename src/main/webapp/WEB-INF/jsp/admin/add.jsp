      ...
      <div class="box">
        <div class="box-header with-border">
          <c:if test="${!empty info }">
				...
				<script>
					setTimeout(function(){
						location.href = "/onrefectory/admin/add.do";
					},3000);
				</script>
		   </c:if>
        </div>
        <div class="box-body">
        	<form id="add_admin_form" method="POST" action="/onrefectory/admin/doAdd.do" class="form-horizontal col-md-offset-2 col-sm-8">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
					<select type="text" class="form-control" name="role" id="role" placeholder="role">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <button id="add_admin_btn" type="submit" class="btn pull-right btn-primary">添加</button>
                  </div>
                </div>
              </div>
            </form>
...
<script src="/onrefectory/static/dist/js/admin.js" type="text/javascript"></script>
<script>
