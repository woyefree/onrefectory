      ...
      <div class="box">
        <div class="box-header with-border">
          <%-- <c:if test="${!empty info }">
				...
				<script>
					setTimeout(function(){
						location.href = "/onrefectory/admin/edit.do"
					},3000);
				</script>
		   </c:if> --%>
        </div>
        <div class="box-body">
        	<form id="update_admin_form" method="POST" action="/onrefectory/admin/update.do" class="form-horizontal col-md-offset-2 col-sm-8">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" readonly value="${admin.tel }" name="tel" id="tel" placeholder="手机号码">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" value="${admin.name }" name="name" id="name" placeholder="姓名">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" readonly value="${admin.email }" name="email" id="email" placeholder="Email">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control" readonly value="${admin.pwd }" name="pwd" id="pwd" placeholder="密码">
                  </div>
                </div>
                <div class="form-group">
                  <label for="email" class="col-sm-2 control-label">权限</label>
                  <div class="col-sm-6">
					<select type="text" class="form-control" readonly value="${admin.role }" name="role" id="role" placeholder="role">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <button id="update_admin_btn" type="button" class="btn pull-right btn-primary">确定</button>
                  </div>
                </div>
              </div>
            </form>
...
<script src="/onrefectory/static/dist/js/admin.js"></script>
<script>
