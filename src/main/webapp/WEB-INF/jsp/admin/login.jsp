...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/onrefectory/static/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>TIANCHEN</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">现在开始你的登录</p>

    <form action="/onrefectory/admin/doLogin.do" method="post">
...
<!-- iCheck -->
<script src="/onrefectory/static/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
